...
from database import get_db, create_tables, User, VerificationCode
from models import UserCreate, UserResponse, UserLogin, ForgotPassword, VerifyEmail, VerifyPasswordReset, ResetPassword, \
    ResendCode
...
async def resend_code(resend_data: ResendCode, db: Session = Depends(get_db)):
    ...
    try:
        if resend_data.code_type == "password_reset":
            ...
            message = "Email verification code resent to your email"
